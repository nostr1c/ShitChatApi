...
namespace ShitChat.Infrastructure.Migrations
{
    ...
    [Migration("20251103152345_userRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShitChat.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ShitChat.Domain.Entities.AppUserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ShitChat.Domain.Entities.Translation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ShitChat.Domain.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShitChat.Domain.Entities.AppUserRole", b =>
                {
                    b.HasOne("ShitChat.Domain.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
